          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem' }}>
              <div>
                ...
                <input required name="firstName" type="text" placeholder="John" style={{ width: '100%', padding: '1.2rem', borderRadius: '12px', border: '1px solid var(--border-color)', outline: 'none', background: '#f8fafc', fontSize: '1rem', transition: 'border-color 0.2s' }} />
              </div>
              <div>
                ...
                <input required name="lastName" type="text" placeholder="Doe" style={{ width: '100%', padding: '1.2rem', borderRadius: '12px', border: '1px solid var(--border-color)', outline: 'none', background: '#f8fafc', fontSize: '1rem', transition: 'border-color 0.2s' }} />
              </div>
            </div>
            ...
            <div>
              ...
              <input required name="email" type="email" placeholder="john@company.com" style={{ width: '100%', padding: '1.2rem', borderRadius: '12px', border: '1px solid var(--border-color)', outline: 'none', background: '#f8fafc', fontSize: '1rem', transition: 'border-color 0.2s' }} />
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem' }}>
              <div>
                ...
                <input required name="company" type="text" placeholder="Your Company" style={{ width: '100%', padding: '1.2rem', borderRadius: '12px', border: '1px solid var(--border-color)', outline: 'none', background: '#f8fafc', fontSize: '1rem', transition: 'border-color 0.2s' }} />
              </div>
              <div>
                ...
                <select name="market" style={{ width: '100%', padding: '1.2rem', borderRadius: '12px', border: '1px solid var(--border-color)', outline: 'none', background: '#f8fafc', fontSize: '1rem', color: 'var(--text-dark)', cursor: 'pointer' }}>
                  <option>UAE</option>
            ...
            <div>
              ...
              <textarea required name="message" rows={4} placeholder="Briefly describe your product and regulatory needs..." style={{ width: '100%', padding: '1.2rem', borderRadius: '12px', border: '1px solid var(--border-color)', outline: 'none', background: '#f8fafc', fontSize: '1rem', resize: 'vertical', transition: 'border-color 0.2s' }}></textarea>
            </div>

            <button type="submit" disabled={status === 'submitting'} className="btn btn-yellow" style={{ width: '100%', padding: '1.5rem', fontSize: '1.2rem', marginTop: '1rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '1px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem', opacity: status === 'submitting' ? 0.7 : 1, cursor: status === 'submitting' ? 'not-allowed' : 'pointer' }}>
              {status === 'submitting' ? 'Sending...' : <>Request Consultation <span>→</span></>}
            </button>

            {status === 'success' && (
              <p style={{ textAlign: 'center', fontSize: '0.95rem', color: '#15803d', fontWeight: 600, margin: 0 }}>
                Thank you! Your message has been sent — we&apos;ll be in touch shortly.
              </p>
            )}
            {status === 'error' && (
              <p style={{ textAlign: 'center', fontSize: '0.95rem', color: '#b91c1c', fontWeight: 600, margin: 0 }}>
                {errorMessage}
              </p>
            )}
